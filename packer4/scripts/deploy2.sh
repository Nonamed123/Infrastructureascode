...
wget https://raw.githubusercontent.com/Nonamed123/deploy-server-puma/config-scripts/packer/files/dem -O /etc/init.d/dem
chmod +x /etc/init.d/dem
update-rc.d dem defaults 90
/etc/init.d/dem start
